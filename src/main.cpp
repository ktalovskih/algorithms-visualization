...
// Input handling (close the window on pressing ESC)
...
void main() {
    gl_Position = vec4(aPos, 1.0); // Position in normalized device coordinates
}
)";
...
int main() {
    ...
    // Set viewport and callback for resizing
